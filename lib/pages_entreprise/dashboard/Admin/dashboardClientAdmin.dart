...
class BLBDashboardClientAdmin extends StatefulWidget {
  const BLBDashboardClientAdmin({ Key? key }) : super(key: key);

  @override
  _BLBDashboardClientAdminState createState() => _BLBDashboardClientAdminState();
}

class _BLBDashboardClientAdminState extends State<BLBDashboardClientAdmin> {
                                ...
                                IconButton(
                                  onPressed: () {
                                    Alert(
                                      ...
                                      closeIcon: Icon(Icons.close, color: Theme.of(context).hintColor,),
                                      desc: "Vous êtes sur le point de supprimer ce client." "\n\n" "Ētes-vous sûr ?",
                                      buttons: [
                                        DialogButton(
                                          child: Text(
                                            "OUI",
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Flexible(
                                                      child: Text(
                                                        "Suppression du client " + data['nom_prenom'] + " avec succès.",
                                                        style: TextStyle(
                                                          color: Theme.of(context).hintColor
                                                        ),
                                                      ),
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Flexible(
                                                      child: Text(
                                                        "Échec de la suppression du client " + data['nom_prenom'] + ".",
                                                        style: TextStyle(
                                                          color: Theme.of(context).hintColor
                                                        ),
                                                      ),
